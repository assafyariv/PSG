========================================================================
    ACTIVEX CONTROL DLL : AvocadoActiveXCtrl Project Overview
========================================================================

ControlWizard has created this project for your AvocadoActiveXCtrl ActiveX Control
...
that make up your AvocadoActiveXCtrl ActiveX Control DLL.

AvocadoActiveXCtrl.vcxproj
...
AvocadoActiveXCtrl.vcxproj.filters
...
AvocadoActiveXCtrl.def
    This file contains information about the ActiveX Control DLL that
    must be provided to run with Microsoft Windows.

AvocadoActiveXCtrl.idl
    This file contains the Object Description Language source code for the
    type library of your control.

/////////////////////////////////////////////////////////////////////////////
CAvocadoActiveXCtrlCtrl control:

AvocadoActiveXCtrlCtrl.h
    This file contains the declaration of the CAvocadoActiveXCtrlCtrl C++ class.

AvocadoActiveXCtrlCtrl.cpp
    This file contains the implementation of the CAvocadoActiveXCtrlCtrl C++ class.

AvocadoActiveXCtrlPropPage.h
    This file contains the declaration of the CAvocadoActiveXCtrlPropPage C++ class.

AvocadoActiveXCtrlPropPage.cpp
    This file contains the implementation of the CAvocadoActiveXCtrlPropPage C++ class.

CAvocadoActiveXCtrlCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CAvocadoActiveXCtrlCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file AvocadoActiveXCtrl.rc.
...
stdafx.h, stdafx.cpp
    ...
    named AvocadoActiveXCtrl.pch and a precompiled types (PCT) file named stdafx.obj.
