...
namespace nvtraverser
{
  ...
  class ClipPlanesElement : public BaseRenderElement
  {
    public:
      ...
      NVSG_API ClipPlanesElement( const nvsg::GroupSharedPtr & group, const nvmath::Mat44f & modelToWorld
      ...
      NVSG_API const nvmath::Plane3f & getClipPlane( unsigned int index ) const;
      ...
      NVSG_API const nvsg::GroupWeakPtr & getGroup() const;
      ...
      NVSG_API const nvmath::Mat44f & getModelToWorld( unsigned int index ) const;
   ...
   *  \sa constructRenderElement, RenderElementPool */
  inline ClipPlanesElement * createClipPlanesElement( RenderElementPool * pool
                                                    , const nvsg::GroupSharedPtr & group
                                                    , const nvmath::Mat44f & modelToWorld
                                                    , const ClipPlanesElement & rhs )
  {
    return( constructRenderElement<ClipPlanesElement,const nvsg::GroupSharedPtr &, const nvmath::Mat44f &
  ...
  inline ClipPlanesElement::ClipPlanesElement( const nvsg::GroupSharedPtr & group
                                             , const nvmath::Mat44f & modelToWorld
                                             , const ClipPlanesElement &rhs )
  ...
  inline const nvsg::GroupWeakPtr & ClipPlanesElement::getGroup() const
  {
    return( m_group );
  }

  inline const nvmath::Mat44f & ClipPlanesElement::getModelToWorld( unsigned int index ) const
  {
