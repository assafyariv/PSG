...
namespace nvsg
{
  ...
  {
    public:
      NVSG_API static BlendAttributeSharedPtr create();
    ...
    public:
      ...
      *  \sa PrimitiveAttribute */
      ...
      REFLECTION_INFO_API( NVSG_API, BlendAttribute );
    protected:
      friend struct nvutil::Holder<BlendAttribute>;
      ...
      /*! \brief Determine the transparency status of this BlendAttribute.
       *  \return \c true, if this BlendAttribute is transparent, otherwise \c false.
       *  \remarks A BlendAttribute is considered to be transparent, if the source function is one
       *  of BF_DESTINATION_COLOR, BF_ONE_MINUS_DESTINATION_COLOR, BF_DESTINATION_ALPHA,
       *  BF_ONE_MINUS_DESTINATION_ALPHA, or BF_SOURCE_ALPHA_SATURATE, or the destination function
       *  is not BF_ZERO. */
