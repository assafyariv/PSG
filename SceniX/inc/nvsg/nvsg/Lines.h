...
{  
  ...
  {
    public:
      NVSG_API static LinesSharedPtr create();
    ...
    public:
      ...
      NVSG_API unsigned int getNumberOfSegments() const;
      ...
      NVSG_API void setSegments( const Segment * segments, unsigned int numSegments );
      ...
      NVSG_API void setSegments( unsigned int pos, const Segment * segments, unsigned int numSegments );
      ...
      REFLECTION_INFO_API( NVSG_API, Lines );
    protected:
      friend struct nvutil::Holder<Lines>;
  ...
  inline unsigned int Lines::getNumberOfSegments()  const
  { 
    NVSG_TRACE();
  ...
  inline void Lines::setSegments( const Segment* pSegments, unsigned int numSegments )
  {
    NVSG_TRACE();
    setIndices( (const unsigned int *) pSegments, 2 * numSegments );
  }

  inline void Lines::setSegments( unsigned int pos, const Segment* pSegments, unsigned int numSegments )
  {
    NVSG_TRACE();
    if ( pos != ~0 )
    {
