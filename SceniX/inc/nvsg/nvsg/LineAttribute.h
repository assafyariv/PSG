...
namespace nvsg
{
  ...
  {
    public:
      NVSG_API static LineAttributeSharedPtr create();
    ...
    public:
      ...
      REFLECTION_INFO_API( NVSG_API, LineAttribute );
    protected:
      friend struct nvutil::Holder<LineAttribute>;
