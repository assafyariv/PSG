...
namespace nvsg
{
  ...
  class IndependentPrimitiveSet : public PrimitiveSet
  {
    public:
      ...
      NVSG_API void setIndices( const unsigned int * indices, unsigned int numIndices );
       ...
       *  \c unsigned \c int located at \a indices.
       *  \sa hasIndices, getNumberOfIndices, getIndices */
      NVSG_API void setIndices( unsigned int pos, const unsigned int * indices, unsigned int numIndices );
      ...
      REFLECTION_INFO_API( NVSG_API, IndependentPrimitiveSet );
    protected:
      ...
      /*! \brief Calculates the bounding box of this IndependentPrimitiveSet.
       *  \return The axis-aligned bounding box of this IndependentPrimitiveSet.
       *  \remarks This function is called by the framework when re-calculation
       *  of the bounding box is required for this IndependentPrimitiveSet. */
    ...
    private:
      nvutil::SmartPtr<nvutil::RCVector<unsigned int> > m_indices;
  };
  ...
  inline unsigned int IndependentPrimitiveSet::getNumberOfIndices()  const
  {
    NVSG_TRACE();
