...
namespace nvsg
{
  ...
  {
    public:
      NVSG_API static PerspectiveCameraSharedPtr create();
    ...
    protected:
      friend struct nvutil::Holder<PerspectiveCamera>;
    ...
    public:
      REFLECTION_INFO_API( NVSG_API, PerspectiveCamera );
      BEGIN_DECLARE_STATIC_PROPERTIES
          NVSG_API DECLARE_STATIC_PROPERTY( FieldOfView );
