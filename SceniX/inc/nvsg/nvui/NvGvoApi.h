...
typedef struct tagNVGVOCONFIG
{
    ...
    DWORD             dwPadding;                            // Number of bytes to pad the data so that the size of newly added data 
                                                            // elements exceeds structure alignment before dwFlipQueueLength was added 
                                                            // into the structure
