...
namespace nvutil
{
  ...
  class TransformStack
  {
    ...
    public:
      ...
      NVSG_API unsigned int getStackDepth( void )   const;
    ...
    private :
      std::stack<nvmath::Mat44f>  m_modelWorld; //!<  stack of concatenated model to world matrices
      std::stack<nvmath::Mat44f>  m_worldModel; //!<  stack of concatenated world to model matrices
      ...
      mutable nvmath::Mat44f  m_clipModel;
      mutable nvmath::Mat44f  m_modelClip;
      mutable nvmath::Mat44f  m_modelView;
      mutable nvmath::Mat44f  m_viewModel;
  ...
  inline  unsigned int  TransformStack::getStackDepth( void ) const
  {
    ...
    return( checked_cast<unsigned int>(m_modelWorld.size()) );
  }
