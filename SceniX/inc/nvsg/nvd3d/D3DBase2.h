...
namespace nvsg {
	...
	class NVD3DBase : public Direct3DBase2
	{
	public:
		...
		void SetTargets (ID3D11RenderTargetView **rtv,ID3D11DepthStencilView *dsv)
		{
			...
			XMStoreFloat4x4(&m_constantBufferData.model, XMMatrixTranspose(XMMatrixRotationY(60.05 * XM_PIDIV4)));
