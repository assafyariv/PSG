...
namespace optix {
  ...
  inline int ContextObj::getCPUNumThreads()
  {
    int cpu_num_threads;
  ...
  inline RTsize ContextObj::getUsedHostMemory()
  {
    RTsize used_mem;
  ...
  inline int ContextObj::getGPUPagingActive()
  {
  ...
  inline int ContextObj::getGPUPagingForcedOff()
  {
